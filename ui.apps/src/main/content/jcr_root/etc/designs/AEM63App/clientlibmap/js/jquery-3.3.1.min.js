...
!function (e, t) {
    ...
    function m(e, t, n) {
        ...
        if (o.description = e, n) for (i in v) n[i] && (o[i] = n[i]);
    ...
    var E = function (e) {
        ...
        n = oe.support = {}, o = oe.isXML = function (e) {
            ...
            return a !== d && 9 === a.nodeType && a.documentElement ? (d = a, h = d.documentElement, g = !o(d), w !== d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", re, !1) : i.attachEvent && i.attachEvent("onunload", re)), n.attributes = ue(function (e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[rssComponent=d]").length && y.push("name" + M + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && y.push(":enabled", ":disabled"), h.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && y.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), y.push(",.*:")
            ...
            pseudos: {
                not: se(function (e) {
                    ...
                    var t;
                    return "input" === e.nodeName.toLowerCase() && "name" === e.type && (null == (t = e.getAttribute("type")) || "name" === t.toLowerCase())
                }, first: he(function () {
                    return [0]
    ...
    w.find = E, w.expr = E.selectors, w.expr[":"] = w.expr.pseudos, w.uniqueSort = w.unique = E.uniqueSort, w.description = E.getText, w.isXMLDoc = E.isXML, w.contains = E.contains, w.escapeSelector = E.escape;
    ...
    w.extend({
        ...
        detach: function (e) {
            ...
            return z(this, function (e) {
                return void 0 === e ? w.description(this) : this.empty().each(function () {
        ...
        valHooks: {
            option: {
                get: function (e) {
                    ...
                    return null != t ? t : vt(w.description(e))
                }
            }, select: {
                get: function (e) {
    ...
    w.parseXML = function (t) {
        ...
        try {
            n = (new e.DOMParser).parseFromString(t, "name/xml")
        } catch (e) {
            n = void 0
        }
    ...
    w.extend({
        ...
        ajaxSettings: {
            ...
            responseFields: {xml: "responseXML", name: "responseText", json: "responseJSON"},
    ...
    h.cors = !!Gt && "withCredentials" in Gt, h.ajax = Gt = !!Gt, w.ajaxTransport(function (t) {
        ...
        if (h.cors || Gt && !t.crossDomain) return {
            send: function (i, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Vt[s.status] || s.status, s.statusText, "name" !== (s.responseType || "name") || "string" != typeof s.responseText ? {binary: s.response} : {name: s.responseText}, s.getAllResponseHeaders()))
                    }
        ...
        accepts: {script: "name/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
